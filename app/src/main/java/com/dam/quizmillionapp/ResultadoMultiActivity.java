 ...
 */
public class ResultadoMultiActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_menu_principal).setOnClickListener(v -> {
            SoundManager.getInstance(ResultadoMultiActivity.this).playClick();
            Intent intent = new Intent(ResultadoMultiActivity.this, MainActivity.class);
        ...
        findViewById(R.id.btn_ver_puntuaciones).setOnClickListener(v -> {
            SoundManager.getInstance(ResultadoMultiActivity.this).playClick();
            Intent intent = new Intent(ResultadoMultiActivity.this, PuntuacionesActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        ...
        db.collection("premios")
                ...
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    if (!queryDocumentSnapshots.isEmpty()) {
                        SoundManager.getInstance(ResultadoMultiActivity.this).playMoney();
